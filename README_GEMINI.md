# 🇮🇳 Indian Direct Tax Drafting — Gemini CLI Port

> The same `indian-tax-drafting` pipeline you know, now invokable from Gemini CLI. **Same 6-agent pipeline. Same canonical agent specs. Same filing-grade output. Different LLM brain.**
...
├── skills/ (case-type templates)                   ← case-type templates (unchanged)
...
**Forum:** CIT(A) / ITAT / High Court Tax Bench / PCIT / CIT / DRP — per forum
