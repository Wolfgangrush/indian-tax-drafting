...
```bash
bash "${CLAUDE_PLUGIN_ROOT}/skills/_tax_drafting_base/pair_md_to_docx.sh" <case-folder>/opposing-notes.md
bash "${CLAUDE_PLUGIN_ROOT}/skills/_tax_drafting_base/pair_md_to_docx.sh" <case-folder>/final-draft.md
```
