...
| `indian-labour-drafting` | [indian-labour-drafting-litigation](https://github.com/Wolfgangrush/indian-labour-drafting-litigation) | Labour / industrial-relations / ESI / EPF / gratuity pleadings |
| `indian-property-drafting` | [indian-property-drafting-litigation](https://github.com/Wolfgangrush/indian-property-drafting-litigation) | Property / land / tenancy / RERA / society pleadings |
| `indian-tax-drafting` (this) | [indian-tax-drafting](https://github.com/Wolfgangrush/indian-tax-drafting) | Direct-tax appellate pleadings + statutory registrations under the Income-tax Act 1961 |
...
**Out of scope for this plugin (covered by other plugins or future releases):** indirect-tax matters (GST / Customs / Excise / Service Tax) before CESTAT / AAR / AAAR — separate plugin if ever built; corporate-insolvency matters before NCLT / NCLAT under the IBC and Companies Act 2013 — sibling plugin in build.
